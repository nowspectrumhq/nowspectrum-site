...
// Single source of truth for nav — update here, updates everywhere
...
(function () {
  ...
  function active(page) {
    if (page === 'home' && (path === '/' || path.endsWith('index.html') || path.endsWith('/'))) return ' active';
